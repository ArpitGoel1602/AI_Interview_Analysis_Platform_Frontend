      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 tet-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28 '>
            {
              [
                ...
                },
                {
                  ...
                  desc: "Dynamic follow-up questions based on you answer."
                },
                {
                  icon: <BsClock size={24} />,
                  step: "STEP 3",
                  title: "Timer Based Simulation",
                  desc: "Real interview pressure with time tracting."
                }
              ].map((item, index) => (
                <motion.div key={index}
                  ...
                  className={`
              relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-88 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
              ${index === 0 ? "rotate-[-4deg]" : ""}
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full md:w-1/2'>
                        ...
                        <p className='text-gray-500 text-sm leading-relative'>{item.desc}</p>
                      </div>
                    </div>
                  </motion.div>
                ))
